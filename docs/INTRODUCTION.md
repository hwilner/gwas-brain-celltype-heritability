...
![Concept figure: the Paper 1 pipeline from harmonized GWAS summary statistics and Allen Brain Cell Atlas cell-type gene programs to per-cell-type heritability enrichment scores.](figures/concept_figure.png)
